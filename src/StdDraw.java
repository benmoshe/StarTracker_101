...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	private static JMenuBar createMenuBar() {
		...
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Add BS");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Remove BS");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Drone Pos");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Ranger10");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Ranger30");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		menuItem1 = new JMenuItem("Ranger100");
		menuItem1.addActionListener(std);
		menu.add(menuItem1);
		return menuBar;
	}
	...
	public void actionPerformed(ActionEvent e) {
		if(e.getActionCommand().equals("Save")) {
			System.out.println("Save: "+e.getActionCommand());
		}
		if(e.getActionCommand().equals("Add BS")) {
			System.out.println("Add BS: "+e.getActionCommand());
			Main._mode = Main.ADD_BS;
		}
		if(e.getActionCommand().equals("Remove BS")) {
			System.out.println("Remove BS: "+e.getActionCommand());
			Main._mode = Main.REMOVE_BS;
		}
		if(e.getActionCommand().equals("Drone Pos")) {
			System.out.println("Drone Pos: "+e.getActionCommand());
			Main._mode = Main.CHANGE_DRONE;
		}
	...
	public void mouseClicked(MouseEvent e) {
		...
		double x = userX(e.getX());
		double y = userY(e.getY());
		//Point3D pp = new Point3D(x, y, 10);
		//Simulator.setDronePos(pp);
	...
	public void keyTyped(KeyEvent e) {
		synchronized (keyLock) {
			...
			if(c==' ') {
	//			boolean runFlag = Simulator.getRun();
	//			Simulator.setRunFlag(!runFlag);
			}
	//		if(c=='a') {Simulator.turnLeft();}
			if(c=='d') {
		//		Simulator.turnRight();
			}
	//		if(c=='w') {Simulator.flyFaster();}
		//	if(c=='x') {Simulator.flySlower();}
		}
	}
